...
clash2 allows you to leech (re-upload) contents from internet including torrent to telegram. This bot using Telegram MTProto powered by pyrogram.
...
[<img src="https://deploy.cloud.run/button.svg" alt="Run on Google Cloud" height="40"/>](https://deploy.cloud.run?git_repo=https://github.com/Clashofclan7seven/2.git "Google Cloud")
...
# get botkaca source
git clone https://github.com/Clashofclan7seven/2.git

# build then execute using docker image
docker build -t Clashofclan7seven/2 botkaca
docker run -it Clashofclan7seven/2
```
